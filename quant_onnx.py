...
input_model_path = Path(current_dir / "models/AnimeGANv3_Shinkai_37.onnx")

parser = argparse.ArgumentParser(description='https://github.com/jason-li-831202/Vehicle-CV-ADAS')
parser.add_argument('--input_onnx_model', '-i', default=input_model_path, type=str, help='onnx model path.')
