...
print(current_dir)
video_dir = Path(current_dir /  "_temp/Apple_Biggest_Update_iOS_18🤣😂😅__._._._._#apple_#appleindia_#appleui_#appleiphone11_#iphone15_#iphonex_#samsunggalaxy_#iphonephotography_#iphonexr_#.mp4")
print(video_dir)
...
def parse_args():
    ...
    parser.add_argument('-i','--input_video_path', type=str, default=video_dir, help='video file or number for webcam')
    parser.add_argument('-m','--model_path', type=str, default='models/AnimeGANv3_Hayao_36.onnx',  help='file path to save the modles')
    parser.add_argument('-o','--output', type=str, default='_temp' ,help='output path')
